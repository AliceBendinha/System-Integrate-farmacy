...
<div
    ...
    x-data="{
        copied: false,
        markdown: <?php echo e(Illuminate\Support\Js::from($markdown)); ?>,
        async copyToClipboard() {
            try {
                await window.copyToClipboard(this.markdown);
                this.copied = true;
...
<?php /**PATH C:\xampp\htdocs\MVC\backend\resources\views/vendor/laravel-exceptions-renderer/components/topbar.blade.php ENDPATH**/ ?>